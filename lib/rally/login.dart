...
import 'package:flipper/rally/app.dart';
import 'package:flipper/rally/colors.dart';
import 'package:flipper/rally/layout/image_placeholder.dart';
        ...
        children: [
          Row(
            ...
            children: [
              ...
              spacing,
              Text(
                FlipperLocalizations.of(context)!.rallyLoginLoginToRally,
          ...
          Row(
            ...
            children: [
              Text(
                FlipperLocalizations.of(context)!.rallyLoginNoAccount,
                style: Theme.of(context).textTheme.subtitle1,
              ),
              spacing,
              _BorderButton(
                text: FlipperLocalizations.of(context)!.rallyLoginSignUp,
              ),
            ],
          ),
        ],
      ...
      child: Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            labelText: FlipperLocalizations.of(context)!.rallyLoginUsername,
          ),
        ),
      ),
    );
    ...
    return Align(
      ...
      child: Container(
        ...
        child: TextField(
          ...
          decoration: InputDecoration(
            labelText: FlipperLocalizations.of(context)!.rallyLoginPassword,
          ),
          obscureText: true,
        ),
      ),
...
class _ThumbButtonState extends State<_ThumbButton> {
  ...
  Widget build(BuildContext context) {
    return Semantics(
      button: true,
      enabled: true,
      label: FlipperLocalizations.of(context)!.rallyLoginLabelLogin,
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Text(FlipperLocalizations.of(context)!.rallyLoginRememberMe),
            const Expanded(child: SizedBox.shrink()),
            _FilledButton(
              text: FlipperLocalizations.of(context)!.rallyLoginButtonLogin,
              onTap: onTap,
            ),
          ],
        ),
