...
import 'package:flipper/rally/charts/line_chart.dart';
...
FinancialEntityCategoryView buildFinancialEntityFromAccountData(
  ...
  return FinancialEntityCategoryView(
    ...
    semanticsLabel: FlipperLocalizations.of(context)!.rallyAccountAmount(
      model.name!,
      shortAccountNumber,
      amount,
    ),
...
FinancialEntityCategoryView buildFinancialEntityFromBillData(
  ...
  return FinancialEntityCategoryView(
    ...
    semanticsLabel: FlipperLocalizations.of(context)!.rallyBillAmount(
      model.name!,
      model.dueDate!,
      amount,
    ),
...
FinancialEntityCategoryView buildFinancialEntityFromBudgetData(
  ...
  return FinancialEntityCategoryView(
    suffix: Text(
      FlipperLocalizations.of(context)!.rallyFinanceLeft,
    ...
    semanticsLabel: FlipperLocalizations.of(context)!.rallyBudgetAmount(
      model.name!,
      model.amountUsed!,
      model.primaryAmount!,
      amount,
    ...
    return ApplyTextOptions(
      child: Scaffold(
        appBar: AppBar(
          ...
          centerTitle: true,
          title: Text(
            FlipperLocalizations.of(context)!.rallyAccountDataChecking,
            style:
