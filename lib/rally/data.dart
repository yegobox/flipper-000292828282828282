...
import 'package:flipper/formatters.dart';
...
class DummyDataService {
  static List<AccountData> getAccountDataList(BuildContext context) {
    return <AccountData>[
      AccountData(
        name: FlipperLocalizations.of(context)!.rallyAccountDataChecking,
        primaryAmount: 2215.13,
        accountNumber: '1234561234',
      ),
      AccountData(
        name: FlipperLocalizations.of(context)!.rallyAccountDataHomeSavings,
        primaryAmount: 8678.88,
        accountNumber: '8888885678',
      ),
      AccountData(
        name: FlipperLocalizations.of(context)!.rallyAccountDataCarSavings,
        primaryAmount: 987.48,
        accountNumber: '8888889012',
      ),
      AccountData(
        name: FlipperLocalizations.of(context)!.rallyAccountDataVacation,
        primaryAmount: 253,
  ...
  static List<UserDetailData> getAccountDetailList(BuildContext context) {
    return <UserDetailData>[
      UserDetailData(
        title: FlipperLocalizations.of(context)!
      ...
      UserDetailData(
        title:
            FlipperLocalizations.of(context)!.rallyAccountDetailDataInterestYtd,
  ...
  static List<UserDetailData> getBillDetailList(BuildContext context,
      {double? dueTotal, required double paidTotal}) {
    return <UserDetailData>[
      UserDetailData(
        title: FlipperLocalizations.of(context)!.rallyBillDetailTotalAmount,
        value: usdWithSignFormat(context).format(paidTotal + dueTotal!),
      ),
      UserDetailData(
        title: FlipperLocalizations.of(context)!.rallyBillDetailAmountPaid,
        value: usdWithSignFormat(context).format(paidTotal),
      ),
      UserDetailData(
        title: FlipperLocalizations.of(context)!.rallyBillDetailAmountDue,
  ...
  static List<BudgetData> getBudgetDataList(BuildContext context) {
    return <BudgetData>[
      BudgetData(
        name: FlipperLocalizations.of(context)!.rallyBudgetCategoryCoffeeShops,
        primaryAmount: 70,
        amountUsed: 45.49,
      ),
      BudgetData(
        name: FlipperLocalizations.of(context)!.rallyBudgetCategoryGroceries,
        primaryAmount: 170,
        amountUsed: 16.45,
      ),
      BudgetData(
        name: FlipperLocalizations.of(context)!.rallyBudgetCategoryRestaurants,
        primaryAmount: 170,
        amountUsed: 123.25,
      ),
      BudgetData(
        name: FlipperLocalizations.of(context)!.rallyBudgetCategoryClothing,
        primaryAmount: 70,
        amountUsed: 19.45,
      ),
    ];
  ...
  static List<UserDetailData> getBudgetDetailList(BuildContext context,
      {double? capTotal, required double usedTotal}) {
    return <UserDetailData>[
      UserDetailData(
        title: FlipperLocalizations.of(context)!.rallyBudgetDetailTotalCap,
        value: usdWithSignFormat(context).format(capTotal),
      ),
      UserDetailData(
        title: FlipperLocalizations.of(context)!.rallyBudgetDetailAmountUsed,
        value: usdWithSignFormat(context).format(usedTotal),
      ),
      UserDetailData(
        title: FlipperLocalizations.of(context)!.rallyBudgetDetailAmountLeft,
  ...
  static List<String> getSettingsTitles(BuildContext context) {
    return <String>[
      FlipperLocalizations.of(context)!.rallySettingsManageAccounts,
      FlipperLocalizations.of(context)!.rallySettingsTaxDocuments,
      FlipperLocalizations.of(context)!.rallySettingsPasscodeAndTouchId,
      FlipperLocalizations.of(context)!.rallySettingsNotifications,
      FlipperLocalizations.of(context)!.rallySettingsPersonalInformation,
      FlipperLocalizations.of(context)!.rallySettingsPaperlessSettings,
      FlipperLocalizations.of(context)!.rallySettingsFindAtms,
      FlipperLocalizations.of(context)!.rallySettingsHelp,
      FlipperLocalizations.of(context)!.rallySettingsSignOut,
    ];
  }
  ...
  static List<AlertData> getAlerts(BuildContext context) {
    return <AlertData>[
      AlertData(
        message: FlipperLocalizations.of(context)!
      ...
      AlertData(
        message: FlipperLocalizations.of(context)!.rallyAlertsMessageATMFees(
