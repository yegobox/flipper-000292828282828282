...
import 'package:flipper/rally/tabs/accounts.dart';
import 'package:flipper/rally/tabs/bills.dart';
import 'package:flipper/rally/tabs/budgets.dart';
import 'package:flipper/rally/tabs/overview.dart';
import 'package:flipper/rally/tabs/settings.dart';
  ...
  Widget build(BuildContext context) {
    ...
    if (isDesktop) {
      final isTextDirectionRtl =
          FlipperOptions.of(context).resolvedTextDirection() ==
              TextDirection.rtl;
  ...
  List<Widget> _buildTabs(
    ...
    return [
      _RallyTab(
        ...
        title: FlipperLocalizations.of(context)!.rallyTitleOverview,
        tabIndex: 0,
        tabController: _tabController!,
      ...
      _RallyTab(
        ...
        title: FlipperLocalizations.of(context)!.rallyTitleAccounts,
        tabIndex: 1,
        tabController: _tabController!,
        isVertical: isVertical,
      ),
      _RallyTab(
        ...
        title: FlipperLocalizations.of(context)!.rallyTitleBills,
        tabIndex: 2,
        tabController: _tabController!,
        isVertical: isVertical,
      ),
      _RallyTab(
        ...
        title: FlipperLocalizations.of(context)!.rallyTitleBudgets,
        tabIndex: 3,
        tabController: _tabController!,
        isVertical: isVertical,
      ),
      _RallyTab(
        ...
        title: FlipperLocalizations.of(context)!.rallyTitleSettings,
        tabIndex: 4,
        tabController: _tabController!,
        isVertical: isVertical,
      ),
