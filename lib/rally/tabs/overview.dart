...
import 'package:flipper/rally/colors.dart';
import 'package:flipper/rally/data.dart';
import 'package:flipper/rally/finance.dart';
import 'package:flipper/rally/layout/adaptive.dart';
import 'package:flipper/rally/layout/text_scale.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (context, constraints) {
      final textScaleFactor =
          FlipperOptions.of(context).textScaleFactor(context);
          ...
          Container(
            ...
            child: MergeSemantics(
              child: Wrap(
                ...
                children: [
                  Text(FlipperLocalizations.of(context)!.rallyAlerts),
                  if (!isDesktop)
                    TextButton(
                      style: TextButton.styleFrom(primary: Colors.white),
                      onPressed: () {},
                      child:
                          Text(FlipperLocalizations.of(context)!.rallySeeAll),
                    ),
                ],
              ),
            ),
        ...
        child: Column(
          ...
          children: [
            ...
            TextButton(
              ...
              onPressed: () {},
              child: Text(
                FlipperLocalizations.of(context)!.rallySeeAll,
