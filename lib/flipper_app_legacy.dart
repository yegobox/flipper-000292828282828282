...
class FlipperAppLegacy extends StatefulWidget {
  @override
  State<FlipperAppLegacy> createState() => _FlipperAppLegacyState();
}

class _FlipperAppLegacyState extends State<FlipperAppLegacy> {
