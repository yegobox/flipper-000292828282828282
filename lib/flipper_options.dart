...
class FlipperOptions {
  ...
  static FlipperOptions of(BuildContext context) {
    final scope =
        context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>();
    return scope!.modelBindingState.currentModel;
  }

  static void update(BuildContext context, FlipperOptions newModel) {
    final scope =
        context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>();
...
class ApplyTextOptions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final options = FlipperOptions.of(context);
...
class ModelBinding extends StatefulWidget {
  ...
  final FlipperOptions initialModel;
  final Widget child;
...
class _ModelBindingState extends State<ModelBinding> {
  late FlipperOptions currentModel;
  ...
  void handleTimeDilation(FlipperOptions newModel) {
  ...
  void updateModel(FlipperOptions newModel) {
