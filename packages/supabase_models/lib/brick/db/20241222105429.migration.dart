...
const List<MigrationCommand> _migration_20241222105429_up = [
...
const List<MigrationCommand> _migration_20241222105429_down = [
  InsertTable('Appnotification'),
  DropTable('AppNotification'),
...
@Migratable(
  version: '20241222105429',
  up: _migration_20241222105429_up,
  down: _migration_20241222105429_down,
)
class Migration20241222105429 extends Migration {
