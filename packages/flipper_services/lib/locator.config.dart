...
import 'abstractions/dynamic_link.dart' as _i8;
...
import 'billing_service.dart' as _i4;
import 'country_service.dart' as _i5;
import 'cron_service.dart' as _i7;
import 'event_service.dart' as _i9;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i3.AppService>(() => thirdPartyServicesModule.appService);
  gh.lazySingleton<_i4.BillingService>(() => thirdPartyServicesModule.billing);
  gh.lazySingleton<_i5.Country>(() => thirdPartyServicesModule.country);
  gh.lazySingleton<_i6.Crash>(() => thirdPartyServicesModule.crash);
  gh.lazySingleton<_i7.CronService>(() => thirdPartyServicesModule.cron);
  gh.lazySingleton<_i8.DynamicLink>(() => thirdPartyServicesModule.dynamicLink);
  gh.lazySingleton<_i9.EventService>(
      () => thirdPartyServicesModule.loginService);
  gh.lazySingleton<_i10.FlipperFirestore>(
...
class _$ThirdPartyServicesModule extends _i29.ThirdPartyServicesModule {
  @override
  _i3.AppService get appService => _i3.AppService();
  @override
  _i4.BillingService get billing => _i4.BillingService();
  @override
  _i7.CronService get cron => _i7.CronService();
  @override
  _i9.EventService get loginService => _i9.EventService();
  @override
