...
import 'package:flipper_ui/widget/ignore_parent_gesture.dart';
import 'package:flipper_ui/widget/spacing.dart';
import 'package:flutter/material.dart';

class FlipperIconTextButton extends StatelessWidget {
...
class FlipperTextButton extends StatelessWidget {
  const FlipperTextButton(
    this.text, {
    super.key,
    this.onPressed,
    this.fontSize,
  ...
  factory FlipperTextButton.primary({
  ...
  factory FlipperTextButton.secondary({
    required BuildContext context,
    required String text,
    VoidCallback? onPressed,
  }) =>
...
class FlipperRichTextButton extends StatelessWidget {
  const FlipperRichTextButton(
    this.text, {
    super.key,
    this.onPressed,
    this.overflow = TextOverflow.ellipsis,
