...
import 'package:flipper_finance/adaptive.dart';
import 'package:flipper_finance/text_scale.dart';
import 'package:flipper_finance/charts/line_chart.dart';
import 'package:flipper_finance/charts/pie_chart.dart';
import 'package:flipper_finance/vertical_fraction_bar.dart';
import 'package:flipper_finance/colors.dart';
import 'package:flipper_finance/data.dart';
import 'package:flipper_finance/formatters.dart';
...
FinancialEntityCategoryView buildFinancialEntityFromAccountData(
  ...
  return FinancialEntityCategoryView(
    ...
    semanticsLabel: "{accountName} account {accountNumber} with {amount}.",
...
FinancialEntityCategoryView buildFinancialEntityFromBillData(
  ...
  return FinancialEntityCategoryView(
    ...
    semanticsLabel: "{billName} bill due {date} for {amount}.",
