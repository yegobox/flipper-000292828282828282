...
const VoucherSchema = CollectionSchema(
  name: 'Voucher',
  schema:
      '{"name":"Voucher","idName":"id","properties":[{"name":"createdAt","type":"Long"},{"name":"descriptor","type":"String"},{"name":"interval","type":"Long"},{"name":"used","type":"Bool"},{"name":"usedAt","type":"Long"},{"name":"value","type":"Long"}],"indexes":[],"links":[]}',
  idName: 'id',
  propertyIds: {
    'createdAt': 0,
    'descriptor': 1,
...
Voucher _voucherDeserializeWeb(
  ...
  final object = Voucher(
    ...
    usedAt: IsarNative.jsObjectGet(jsObj, 'usedAt') ?? double.negativeInfinity,
