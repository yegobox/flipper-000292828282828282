...
void _userActivitySerialize(
  ...
  writer.writeDateTime(offsets[2], object.lastTouched);
...
UserActivity _userActivityDeserialize(
  ...
  final object = UserActivity(
    ...
    id: id,
    lastTouched: reader.readDateTimeOrNull(offsets[2]),
...
extension UserActivityQueryWhereDistinct
  ...
  QueryBuilder<UserActivity, UserActivity, QDistinct> distinctByAction(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserActivity, UserActivity, QDistinct> distinctByDeletedAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'deletedAt');
    });
  }

  QueryBuilder<UserActivity, UserActivity, QDistinct> distinctByLastTouched() {
    return QueryBuilder.apply(this, (query) {
...
extension UserActivityQueryProperty
  ...
  QueryBuilder<UserActivity, String, QQueryOperations> actionProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'action');
    });
  }

  QueryBuilder<UserActivity, DateTime?, QQueryOperations> deletedAtProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'deletedAt');
    });
  }

  QueryBuilder<UserActivity, DateTime?, QQueryOperations>
      lastTouchedProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserActivity, int, QQueryOperations> userIdProperty() {
    return QueryBuilder.apply(this, (query) {
