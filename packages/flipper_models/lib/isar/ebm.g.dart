...
void _eBMSerialize(
  ...
  writer.writeString(offsets[7], object.taxServerUrl);
  writer.writeLong(offsets[8], object.tinNumber);
...
EBM _eBMDeserialize(
  ...
  final object = EBM(
    ...
    taxServerUrl: reader.readStringOrNull(offsets[7]),
    tinNumber: reader.readLong(offsets[8]),
...
extension EBMQueryFilter on QueryBuilder<EBM, EBM, QFilterCondition> {
  ...
  QueryBuilder<EBM, EBM, QAfterFilterCondition> userIdEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'userId',
        value: value,
...
extension EBMQueryProperty on QueryBuilder<EBM, EBM, QQueryProperty> {
  ...
  QueryBuilder<EBM, int, QQueryOperations> userIdProperty() {
    return QueryBuilder.apply(this, (query) {
