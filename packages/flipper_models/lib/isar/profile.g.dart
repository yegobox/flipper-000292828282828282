...
void _profileSerialize(
  ...
  writer.writeString(offsets[14], object.nationalId);
  writer.writeString(offsets[15], object.phone);
  writer.writeString(offsets[16], object.pincode);
  writer.writeString(offsets[17], object.profilePic);
  writer.writeString(offsets[18], object.state);
  writer.writeString(offsets[19], object.vaccinationCode);
}
...
Profile _profileDeserialize(
  ...
  final object = Profile(
    ...
    nationalId: reader.readStringOrNull(offsets[14]),
    phone: reader.readStringOrNull(offsets[15]),
    pincode: reader.readStringOrNull(offsets[16]),
    profilePic: reader.readStringOrNull(offsets[17]),
    state: reader.readStringOrNull(offsets[18]),
    vaccinationCode: reader.readString(offsets[19]),
  );
...
extension ProfileQueryWhereSort on QueryBuilder<Profile, Profile, QWhere> {
  ...
  QueryBuilder<Profile, Profile, QAfterWhere> anyLastTouched() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension ProfileQueryWhere on QueryBuilder<Profile, Profile, QWhereClause> {
  ...
  QueryBuilder<Profile, Profile, QAfterWhereClause> lastTouchedGreaterThan(
    DateTime? lastTouched, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterWhereClause> lastTouchedLessThan(
    DateTime? lastTouched, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Profile, Profile, QAfterWhereClause> lastTouchedBetween(
...
extension ProfileQueryProperty
  ...
  QueryBuilder<Profile, DateTime?, QQueryOperations> lastTouchedProperty() {
    return QueryBuilder.apply(this, (query) {
