...
extension TokenQueryWhere on QueryBuilder<Token, Token, QWhereClause> {
  ...
  QueryBuilder<Token, Token, QAfterWhereClause> userIdNotEqualTo(
      String? userId) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension TokenQueryFilter on QueryBuilder<Token, Token, QFilterCondition> {
  ...
  QueryBuilder<Token, Token, QAfterFilterCondition> userIdEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Token, Token, QAfterFilterCondition> userIdStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Token, Token, QAfterFilterCondition> userIdEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Token, Token, QAfterFilterCondition> userIdContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'userId',
  ...
  QueryBuilder<Token, Token, QAfterFilterCondition> userIdMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
...
extension TokenQuerySortBy on QueryBuilder<Token, Token, QSortBy> {
  ...
  QueryBuilder<Token, Token, QAfterSortBy> sortByUserId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userId', Sort.asc);
    });
  }

  QueryBuilder<Token, Token, QAfterSortBy> sortByUserIdDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension TokenQuerySortThenBy on QueryBuilder<Token, Token, QSortThenBy> {
  ...
  QueryBuilder<Token, Token, QAfterSortBy> thenByUserId() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userId', Sort.asc);
    });
  }

  QueryBuilder<Token, Token, QAfterSortBy> thenByUserIdDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'userId', Sort.desc);
    });
  }
...
extension TokenQueryWhereDistinct on QueryBuilder<Token, Token, QDistinct> {
  ...
  QueryBuilder<Token, Token, QDistinct> distinctByUserId(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension TokenQueryProperty on QueryBuilder<Token, Token, QQueryProperty> {
  ...
  QueryBuilder<Token, String?, QQueryOperations> userIdProperty() {
    return QueryBuilder.apply(this, (query) {
