...
void _transactionItemSerialize(
  ...
  writer.writeString(offsets[2], object.addInfo);
  writer.writeString(offsets[3], object.bcd);
  writer.writeString(offsets[4], object.bhfId);
  writer.writeLong(offsets[5], object.branchId);
  writer.writeString(offsets[6], object.createdAt);
  writer.writeDouble(offsets[7], object.dcAmt);
  writer.writeDouble(offsets[8], object.dcRt);
  writer.writeDateTime(offsets[9], object.deletedAt);
  writer.writeDouble(offsets[10], object.dftPrc);
  writer.writeDouble(offsets[11], object.discount);
  writer.writeBool(offsets[12], object.doneWithTransaction);
  writer.writeBool(offsets[13], object.isRefunded);
  writer.writeBool(offsets[14], object.isTaxExempted);
  writer.writeString(offsets[15], object.isrcAmt);
  writer.writeString(offsets[16], object.isrcAplcbYn);
  writer.writeString(offsets[17], object.isrcRt);
  writer.writeString(offsets[18], object.isrccCd);
  writer.writeString(offsets[19], object.isrccNm);
  writer.writeString(offsets[20], object.itemCd);
  writer.writeString(offsets[21], object.itemClsCd);
  writer.writeString(offsets[22], object.itemNm);
  writer.writeString(offsets[23], object.itemSeq);
  writer.writeString(offsets[24], object.itemStdNm);
  writer.writeString(offsets[25], object.itemTyCd);
  writer.writeDateTime(offsets[26], object.lastTouched);
  ...
  writer.writeLong(offsets[46], object.transactionId);
  writer.writeString(offsets[47], object.type);
  writer.writeString(offsets[48], object.updatedAt);
  writer.writeString(offsets[49], object.useYn);
  writer.writeLong(offsets[50], object.variantId);
}
...
TransactionItem _transactionItemDeserialize(
  ...
  final object = TransactionItem(
    ...
    addInfo: reader.readStringOrNull(offsets[2]),
    bcd: reader.readStringOrNull(offsets[3]),
    bhfId: reader.readStringOrNull(offsets[4]),
    branchId: reader.readLong(offsets[5]),
    createdAt: reader.readString(offsets[6]),
    dcAmt: reader.readDoubleOrNull(offsets[7]),
    dcRt: reader.readDoubleOrNull(offsets[8]),
    deletedAt: reader.readDateTimeOrNull(offsets[9]),
    dftPrc: reader.readDoubleOrNull(offsets[10]),
    discount: reader.readDoubleOrNull(offsets[11]),
    doneWithTransaction: reader.readBoolOrNull(offsets[12]),
    id: id,
    isRefunded: reader.readBoolOrNull(offsets[13]),
    isTaxExempted: reader.readBool(offsets[14]),
    isrcAmt: reader.readStringOrNull(offsets[15]),
    isrcAplcbYn: reader.readStringOrNull(offsets[16]),
    isrcRt: reader.readStringOrNull(offsets[17]),
    isrccCd: reader.readStringOrNull(offsets[18]),
    isrccNm: reader.readStringOrNull(offsets[19]),
    itemCd: reader.readStringOrNull(offsets[20]),
    itemClsCd: reader.readStringOrNull(offsets[21]),
    itemNm: reader.readStringOrNull(offsets[22]),
    itemSeq: reader.readStringOrNull(offsets[23]),
    itemStdNm: reader.readStringOrNull(offsets[24]),
    itemTyCd: reader.readStringOrNull(offsets[25]),
    lastTouched: reader.readDateTimeOrNull(offsets[26]),
    ...
    prc: reader.readDouble(offsets[33]),
    ...
    transactionId: reader.readLong(offsets[46]),
    type: reader.readStringOrNull(offsets[47]),
    updatedAt: reader.readString(offsets[48]),
    useYn: reader.readStringOrNull(offsets[49]),
    variantId: reader.readLong(offsets[50]),
  );
  return object;
}
...
extension TransactionItemQueryWhereDistinct
  ...
  QueryBuilder<TransactionItem, TransactionItem, QDistinct> distinctByActive() {
    return QueryBuilder.apply(this, (query) {
...
extension TransactionItemQueryProperty
  ...
  QueryBuilder<TransactionItem, bool?, QQueryOperations> activeProperty() {
    return QueryBuilder.apply(this, (query) {
