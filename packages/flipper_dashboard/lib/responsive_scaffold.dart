...
///
/// (c) BSD 3-clause - Mura Richard (@Richard)
                  ...
                  child: ClipRect(
                    child: OverflowBox(
                      ...
                      child: ListView(
                        ...
                        children: <Widget>[
                          // A  user profile on the menu/rail.
                          _UserProfile(
                            railWidth: widget.railWidth,
                            model: widget.model,
                          ),
                          ...
                          if (ProxyService.remoteConfig
                            ...
                            _MenuItem(
                              ...
                              onTap: () {
                                ...
                                widget.onSelect?.call(MenuConfig.addMember);
                              },
                          ...
                          _MenuItem(
                            ...
                            onTap: () {
                              ...
                              widget.onSelect?.call(MenuConfig.settings);
                            },
                          ...
                          _MenuItem(
                            ...
                            onTap: () {
                              ...
                              widget.onSelect?.call(MenuConfig.darkMode);
                            },
                          ...
                          _MenuItem(
                            ...
                            onTap: () {
                              ...
                              widget.onSelect?.call(MenuConfig.share);
                            },
      ...
      child: Column(
        children: <Widget>[
          ListTile(
            ...
            // leading: avatarBuilder(widget.model.businesses[0], Colors.red),
