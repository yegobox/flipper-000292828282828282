    ...
    return SafeArea(
      ...
      body: StreamBuilder<Social>(
          stream: ProxyService.isarApi
              .socialsStream(businessId: ProxyService.box.getBusinessId() ?? 0),
            ...
            if (snapshot.hasData) {
              ...
              return Column(
                children: [
                  ...
                  Padding(
                    padding:
                        const EdgeInsets.only(top: 64.0, right: 144, left: 144),
                    child: Stack(
                      children: [
                        const CircleAvatar(
                        ...
                        Positioned(
                          ...
                          right: 0,
                          child: ChatBubble(
                            clipper: CustomPainte(type: BubbleType.sendBubble),
