...
jobs:
  ...
  # https://github.com/ksheremet/flutter_actions/blob/master/.github/workflows/flutter-drive.yml
  # https://github.com/ReactiveCircus/android-emulator-runner
  # https://developpaper.com/test-and-deploy-flutter-on-github-actions/
  # integrationTest:
  ...
  build:
    ...
    steps:
      ...
      - name: Update version in YAML
        run: sed -i 's/99.99.99+99/1.9.29+11122/g' pubspec.yaml
      ...
      - name: Create a Release in GitHub
        ...
        with:
          ...
          tag: 1.9.29+11122 # ${{ steps.version.outputs.content }}
          commit: ${{ github.sha }}
